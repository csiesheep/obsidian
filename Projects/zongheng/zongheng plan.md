...
- **#109** running: the en place prompt overflows its box (454 px in 339 px) and, with the advisor off, the prompt row collapses to zero height at 375/390 — which can hide #97's scoring warning. Both pre-existing, found while verifying #107.
